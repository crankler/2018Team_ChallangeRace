...
class IsClose(Task):
    ...
    def run(self):
        if env.EnemyPoseSave_robot1.enemy_dist < 1.52 and env.EnemyPoseSave_robot1.enemy_dist > 0 and self.blackboard.Blocked_Prevent_close == False:
...
class IsFar(Task):
    ...
    def run(self):
        if env.EnemyPoseSave_robot1.enemy_dist > 1.52 and self.blackboard.Blocked_Prevent_far == False:
            self.blackboard.sended_close = False
            self.blackboard.sended_beated = False
            self.blackboard.sended_patrol = False
            self.blackboard.sended_follow = False
